...
public final class ConfigurationFile {
	...
	//public static String INSTANCE_TOPOLOGY="resources/topology/map2022-topologyExam1-draft.dgs"; // A TESTER ICI EGALEMENT
	//public static String INSTANCE_TOPOLOGY="resources/topology/map2022-topologyExam-V2b.dgs"; //PAREIL
