 ...
 *
 */
public class ShareMapOptiBehaviour extends SimpleBehaviour {
	 ...
	 */
	public ShareMapOptiBehaviour(Agent a,MapRepresentation mymap, String myNextNode, List<String> receivers) {
		super(a);
		this.myMap=mymap;
