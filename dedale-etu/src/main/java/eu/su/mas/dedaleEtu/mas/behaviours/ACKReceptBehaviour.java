 ...
 *
 */
public class ACKReceptBehaviour extends SimpleBehaviour {
 ...
 */
	public ACKReceptBehaviour(final AbstractDedaleAgent myagent, MapRepresentation myMap, String myNextNode, List<String> receivers) {
		super(myagent);
